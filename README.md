...
**Write Bitcoin smart contracts in TypeScript, Go, Rust, Python, Zig, Solidity, or Move. Compile to Bitcoin Script.**
...
All 21 examples are available in `ts/`, `go/`, `rust/`, `python/`, and `zig/`. A 16-contract subset is also available in `sol/` and `move/`.
```
examples/
