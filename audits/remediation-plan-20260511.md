...
| GAP-013 | B8 `--parse-only` test | Go | `compilers/go/main_test.go` (or extend) | minor | 13 | resolved 2026-05-12 (added `compilers/go/cli_parse_only_test.go`, 3 tests) |
...
| GAP-015 | B8 `--parse-only` test | Zig | `compilers/zig/src/main.zig` inline test | minor | 15 | resolved 2026-05-12 (7 inline `test "parseCompileOptions: …"` blocks at `compilers/zig/src/main.zig:441+`; main.zig now imported from `test_main.zig` so the tests run under `zig build test`) |
...
| GAP-019 | C3 `addOutput` test | Python | `compilers/python/tests/test_addoutput.py` (new) | minor | 19 | resolved 2026-05-12 |
| GAP-020 | C4 `addRawOutput` test | Rust | `compilers/rust/tests/compiler_tests.rs` extension | minor | 20 | resolved 2026-05-12 (added `compilers/rust/tests/addraw_output_codegen_test.rs`, 8 tests covering OP_SIZE/NUM2BIN/CAT counts, no-OP_RETURN, exactly-1 OP_CODESEPARATOR, determinism) |
| GAP-021 | C4 `addRawOutput` test | Python | `compilers/python/tests/test_addrawoutput.py` (new) | minor | 21 | resolved 2026-05-12 |
...
| GAP-023 | C6 `checkPreimage` test | Python | `compilers/python/tests/test_check_preimage.py` (new) | minor | 23 | resolved 2026-05-12 |
...
| GAP-025 | C7 `codeSeparatorIndices` test | Python | extend `compilers/python/tests/test_emit.py` | minor | 25 | resolved 2026-05-12 (added `tests/codegen/test_codeseparator.py`) |
...
| GAP-027 | D4 `Point` test | Python | `compilers/python/tests/test_point_type.py` (new) | minor | 27 | resolved 2026-05-12 |
...
| GAP-029 | D9 `while` test | Python | `compilers/python/tests/test_while.py` (new) | minor | 29 | resolved 2026-05-12 |
...
| GAP-034 | F6/F7 hash160/hash256 test | Python | extend `compilers/python/tests/codegen/test_hash_builtins.py` (or new) | minor | 34 | resolved 2026-05-12 |
| GAP-035 | F10/F11 checkSig/checkMultiSig test | Python | `compilers/python/tests/codegen/test_check_sig.py` (new) | minor | 35 | resolved 2026-05-12 |
| GAP-036 | F11 checkMultiSig dedicated test | Java | `compilers/java/src/test/java/runar/compiler/codegen/CheckMultiSigTest.java` (new) | minor | 36 | resolved 2026-05-12 (7 tests covering 2-of-3 + 3-of-5 multisig: exactly-1 OP_CHECKMULTISIG, push(0) OP_0 dummy, push(2)+push(3) for 2-of-3, push(3)+push(5) for 3-of-5, peephole-aware emit hex contains 0xae or 0xaf, determinism) |
| GAP-037 | F12 WOTS+ byte parity test / S-2 (BUG-007) | Python | strengthen `compilers/python/tests/test_multiformat.py:324` to op-shape goldens | minor | 37 | resolved 2026-05-12 (added new dedicated `tests/codegen/test_wots_byte_parity.py` with op-count + leading-op-shape + byte-identical hex vs conformance fixture; existing test_multiformat.py:324 left as separate ANF-presence guard) |
...
| GAP-040 | F14 Rabin codegen test | Zig | inline test in `pq_emitters.zig` | minor | 40 | resolved 2026-05-12 (3 inline tests at `compilers/zig/src/compiler_api.zig:341+` covering source→hex pipeline for verifyRabinSig: load-bearing OP_MUL/OP_MOD/OP_SHA256/OP_EQUAL bytes; contiguous 10-opcode Rabin subsequence in hex; appendVerifyRabinSig emits exactly 10 named opcodes in reference order) |
| GAP-041 | G3 WhatsOnChainProvider test | Python | `packages/runar-py/tests/test_woc_provider.py` (new) | minor | 41 | resolved 2026-05-12 |
...
| GAP-043 | G4 GorillaPoolProvider test | Python | `packages/runar-py/tests/test_gorillapool_provider.py` (new) | minor | 43 | resolved 2026-05-12 |
