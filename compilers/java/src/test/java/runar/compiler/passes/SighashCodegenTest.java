...
class SighashCodegenTest {
     ...
     * offsets — the OP_PUSH_TX binding flag byte (byte 387) and the
     * auto-injected preimage-type assert const (byte 433) — each 0x41 -> 0x43.
    ...
    void singleDiffersFromDefaultAtExactlyTheTwoSighashBytes() throws Exception {
        ...
        assertEquals(java.util.List.of(387, 433), diffBytes,
