...
class TestTicTacToeCrossCompilerBytes:
    def test_canonical_ts_v1_locks_to_expected_bytes(self):
    ...
    def test_canonical_ts_v2_locks_to_expected_bytes(self):
    ...
    def test_python_dsl_source_locks_to_expected_bytes(self):
