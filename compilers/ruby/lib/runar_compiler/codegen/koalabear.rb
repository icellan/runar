...
module RunarCompiler
  module Codegen
    module KoalaBear
      ...
      # construction.
      def self.kb_emit_canon_verify(t, *names)
        names.each do |n|
          t.copy_to_top(n, "_cv")
          t.raw_block(["_cv"], nil) do |e|
            e.call(make_stack_op(op: "push", value: big_int_push(0)))
            e.call(make_stack_op(op: "push", value: big_int_push(KB_P)))
      ...
      def self.kb_ext4_mul_component(emit, component)
        ...
        kb_emit_canon_verify(t, "a0", "a1", "a2", "a3", "b0", "b1", "b2", "b3")
      ...
      def self.kb_ext4_inv_component(emit, component)
        ...
        kb_emit_canon_verify(t, "a0", "a1", "a2", "a3")
