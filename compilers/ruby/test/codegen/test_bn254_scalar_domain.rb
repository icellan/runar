...
class TestBn254ScalarDomain < Minitest::Test
  ...
  # coordinates and inherits the OP_SIZE-64 verify that the decomposer gained,
  # because the predicate used to certify (x+p) || y and a 65-byte blob as
  # points. 42_910 ops / 134_245 bytes -> 42_921 ops / 134_321 bytes; the new
  # digest was produced by Go and independently reproduced, byte for byte, by
  # the TypeScript, Python and Ruby tiers before it was written down here.
  LADDER_SHA256 = "a80bb1910366d399b7d6a6a35f7c8b51678d3655bf6008a6744b57aa2bded02c"
