...
const CASES = [_]Case{
    ...
    .{ .label = "loop-body", .source = LOOP_BODY, .want_len = 701, .want_sha = "d38d2062c8f9458c3658c5d0c3bc17978c0a7bc8e4e2ab4a767892129d40d81a" },
    .{ .label = "loop-body-manual", .source = LOOP_BODY_MANUAL, .want_len = 701, .want_sha = "d38d2062c8f9458c3658c5d0c3bc17978c0a7bc8e4e2ab4a767892129d40d81a" },
