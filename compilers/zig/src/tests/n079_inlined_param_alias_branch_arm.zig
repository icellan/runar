...
const CASES = [_]Case{
    .{ .label = "if-arm", .source = IF_ARM, .want_len = 702, .want_sha = "92db59e2c0e61df6dbeef8256d0c37ac1f74880f71d22bdd1e992fab9e257507" },
    .{ .label = "if-arm-manual", .source = IF_ARM_MANUAL, .want_len = 702, .want_sha = "92db59e2c0e61df6dbeef8256d0c37ac1f74880f71d22bdd1e992fab9e257507" },
    .{ .label = "if-arm-200", .source = IF_ARM_200, .want_len = 703, .want_sha = "7584c506d6b04e415c9036f8e345c749dc1661ef6dd13c7a05aa83597ddbd840" },
    .{ .label = "ternary-arm", .source = TERNARY_ARM, .want_len = 688, .want_sha = "ed951f38c72d41f09b0e20d9aeb1408693cbc7936f3e9ea7b6d34905ed6df613" },
    .{ .label = "ternary-arm-manual", .source = TERNARY_ARM_MANUAL, .want_len = 688, .want_sha = "ed951f38c72d41f09b0e20d9aeb1408693cbc7936f3e9ea7b6d34905ed6df613" },
    .{ .label = "loop-body", .source = LOOP_BODY, .want_len = 695, .want_sha = "af13b9a1c80743a69ed0181c4bf227d99f632b18a2f8d71f51cf694b720e9590" },
    .{ .label = "loop-body-manual", .source = LOOP_BODY_MANUAL, .want_len = 695, .want_sha = "af13b9a1c80743a69ed0181c4bf227d99f632b18a2f8d71f51cf694b720e9590" },
    .{ .label = "no-if", .source = NO_IF, .want_len = 680, .want_sha = "bfea7ecbf3196c7e4943227546da0918055d0c11548ba41ac4b45676f741f170" },
    .{ .label = "stmt-level", .source = STMT_LEVEL, .want_len = 698, .want_sha = "0b1e61517510b65cbdb2f18458df8c3d67b0decd116aabf592f3aef5e936a470" },
    .{ .label = "passthrough", .source = PASSTHROUGH, .want_len = 700, .want_sha = "1e7409174b2026df384f2d22e3baf6b8926ee9bfd4e17772f004bd7711a5f7e5" },
};
