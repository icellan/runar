...
type PostQuantumSLHDSANaiveInsecure128f struct {
	runar.SmartContract
	Pubkey runar.ByteString `runar:"readonly"`
}

func (c *PostQuantumSLHDSANaiveInsecure128f) Spend(msg runar.ByteString, sig runar.ByteString) {
	runar.Assert(runar.VerifySLHDSA_SHA2_128f(msg, sig, c.Pubkey))
}
