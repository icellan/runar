...
type PostQuantumSLHDSANaiveInsecure192f struct {
	runar.SmartContract
	Pubkey runar.ByteString `runar:"readonly"`
}

func (c *PostQuantumSLHDSANaiveInsecure192f) Spend(msg runar.ByteString, sig runar.ByteString) {
	runar.Assert(runar.VerifySLHDSA_SHA2_192f(msg, sig, c.Pubkey))
}
