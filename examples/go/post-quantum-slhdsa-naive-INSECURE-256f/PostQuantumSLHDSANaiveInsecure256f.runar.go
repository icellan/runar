...
type PostQuantumSLHDSANaiveInsecure256f struct {
	runar.SmartContract
	Pubkey runar.ByteString `runar:"readonly"`
}

func (c *PostQuantumSLHDSANaiveInsecure256f) Spend(msg runar.ByteString, sig runar.ByteString) {
	runar.Assert(runar.VerifySLHDSA_SHA2_256f(msg, sig, c.Pubkey))
}
