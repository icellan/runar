...
type StateCovenantMechanics struct {
...
func (c *StateCovenantMechanics) AdvanceState(
	...
	// R-192: keeps the readonly commitment live.
	runar.Assert(runar.Len(c.VerifyingKeyHash) == 32)
