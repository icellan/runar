...
// THE FLAW
// --------
// verifySLHDSA_SHA2_128f (and any post-quantum signature primitive: WOTS+,
...
package runar.examples.postquantumslhdsanaiveinsecure128f;
...
import static runar.lang.Builtins.verifySLHDSA_SHA2_128f;

/**
 * PostQuantumSLHDSANaiveInsecure128f -- INSECURE pedagogical fixture exercising
 ...
 * analysis.
 */
class PostQuantumSLHDSANaiveInsecure128f extends SmartContract {

    @Readonly ByteString pubkey;

    PostQuantumSLHDSANaiveInsecure128f(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
    ...
    void spend(ByteString msg, ByteString sig) {
        assertThat(verifySLHDSA_SHA2_128f(msg, sig, this.pubkey));
    }
}
