...
package runar.examples.postquantumslhdsanaiveinsecure192f;
...
import static runar.lang.Builtins.verifySLHDSA_SHA2_192f;

/**
 * PostQuantumSLHDSANaiveInsecure192f -- INSECURE pedagogical fixture exercising
...
class PostQuantumSLHDSANaiveInsecure192f extends SmartContract {
    ...
    PostQuantumSLHDSANaiveInsecure192f(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
    ...
    void spend(ByteString msg, ByteString sig) {
        assertThat(verifySLHDSA_SHA2_192f(msg, sig, this.pubkey));
    }
}
