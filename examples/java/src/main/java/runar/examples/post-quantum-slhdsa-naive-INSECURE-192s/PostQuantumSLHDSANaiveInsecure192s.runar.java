...
package runar.examples.postquantumslhdsanaiveinsecure192s;
...
import static runar.lang.Builtins.verifySLHDSA_SHA2_192s;

/**
 * PostQuantumSLHDSANaiveInsecure192s -- INSECURE pedagogical fixture exercising
...
class PostQuantumSLHDSANaiveInsecure192s extends SmartContract {
    ...
    PostQuantumSLHDSANaiveInsecure192s(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
    ...
    void spend(ByteString msg, ByteString sig) {
        assertThat(verifySLHDSA_SHA2_192s(msg, sig, this.pubkey));
    }
}
