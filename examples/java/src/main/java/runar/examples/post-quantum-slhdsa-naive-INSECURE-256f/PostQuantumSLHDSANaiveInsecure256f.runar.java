...
package runar.examples.postquantumslhdsanaiveinsecure256f;
...
import static runar.lang.Builtins.verifySLHDSA_SHA2_256f;

/**
 * PostQuantumSLHDSANaiveInsecure256f -- INSECURE pedagogical fixture exercising
...
class PostQuantumSLHDSANaiveInsecure256f extends SmartContract {
    ...
    PostQuantumSLHDSANaiveInsecure256f(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
    ...
    void spend(ByteString msg, ByteString sig) {
        assertThat(verifySLHDSA_SHA2_256f(msg, sig, this.pubkey));
    }
}
