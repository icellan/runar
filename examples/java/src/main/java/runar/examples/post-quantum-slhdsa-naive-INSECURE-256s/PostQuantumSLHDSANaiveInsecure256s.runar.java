...
package runar.examples.postquantumslhdsanaiveinsecure256s;
...
import static runar.lang.Builtins.verifySLHDSA_SHA2_256s;

/**
 * PostQuantumSLHDSANaiveInsecure256s -- INSECURE pedagogical fixture exercising
...
class PostQuantumSLHDSANaiveInsecure256s extends SmartContract {
    ...
    PostQuantumSLHDSANaiveInsecure256s(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
    ...
    void spend(ByteString msg, ByteString sig) {
        assertThat(verifySLHDSA_SHA2_256s(msg, sig, this.pubkey));
    }
}
