...
/**
 * PostQuantumWOTSNaiveInsecure -- INSECURE pedagogical fixture exercising the
 * one-time WOTS+ post-quantum signature verification primitive without any
 * transaction binding. See the file header for the full security analysis.
 */
class PostQuantumWOTSNaiveInsecure extends SmartContract {

    @Readonly ByteString pubkey;

    PostQuantumWOTSNaiveInsecure(ByteString pubkey) {
        super(pubkey);
        this.pubkey = pubkey;
    }
