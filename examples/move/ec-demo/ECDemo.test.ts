...
const source = readFileSync(join(__dirname, 'ECDemo.runar.move'), 'utf8');
const FILE_NAME = 'ECDemo.runar.move';

/**
 * ECDemo (Move) tests — uses real secp256k1 points.
 * See examples/ts/ec-demo/ECDemo.test.ts for detailed explanations.
 */
describe('ECDemo (Move)', () => {
