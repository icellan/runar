...
// THE FLAW
// --------
// `verifySlhdsaSha2128f` (and any post-quantum signature primitive: WOTS+,
...
module PostQuantumSLHDSANaiveInsecure128f {
    use runar::types::{ByteString};
    use runar::crypto::{verifySlhdsaSha2128f};

    struct PostQuantumSLHDSANaiveInsecure128f {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumSLHDSANaiveInsecure128f, msg: ByteString, sig: ByteString) {
        assert!(verifySlhdsaSha2128f(msg, sig, contract.pubkey), 0);
    }
}
