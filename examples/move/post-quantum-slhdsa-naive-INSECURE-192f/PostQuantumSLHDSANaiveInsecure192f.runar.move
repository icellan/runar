...
// THE FLAW
// --------
// `verifySlhdsaSha2192f` (and any post-quantum signature primitive: WOTS+,
...
module PostQuantumSLHDSANaiveInsecure192f {
    use runar::types::{ByteString};
    use runar::crypto::{verifySlhdsaSha2192f};

    struct PostQuantumSLHDSANaiveInsecure192f {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumSLHDSANaiveInsecure192f, msg: ByteString, sig: ByteString) {
        assert!(verifySlhdsaSha2192f(msg, sig, contract.pubkey), 0);
    }
}
