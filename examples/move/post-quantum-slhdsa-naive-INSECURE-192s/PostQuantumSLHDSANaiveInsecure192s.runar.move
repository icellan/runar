...
// THE FLAW
// --------
// `verifySlhdsaSha2192s` (and any post-quantum signature primitive: WOTS+,
...
module PostQuantumSLHDSANaiveInsecure192s {
    use runar::types::{ByteString};
    use runar::crypto::{verifySlhdsaSha2192s};

    struct PostQuantumSLHDSANaiveInsecure192s {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumSLHDSANaiveInsecure192s, msg: ByteString, sig: ByteString) {
        assert!(verifySlhdsaSha2192s(msg, sig, contract.pubkey), 0);
    }
}
