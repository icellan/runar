...
// THE FLAW
// --------
// `verifySlhdsaSha2256f` (and any post-quantum signature primitive: WOTS+,
...
module PostQuantumSLHDSANaiveInsecure256f {
    use runar::types::{ByteString};
    use runar::crypto::{verifySlhdsaSha2256f};

    struct PostQuantumSLHDSANaiveInsecure256f {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumSLHDSANaiveInsecure256f, msg: ByteString, sig: ByteString) {
        assert!(verifySlhdsaSha2256f(msg, sig, contract.pubkey), 0);
    }
}
