...
// THE FLAW
// --------
// `verifySlhdsaSha2128s` (and any post-quantum signature primitive: WOTS+,
...
module PostQuantumSLHDSANaiveInsecure {
    use runar::types::{ByteString};
    use runar::crypto::{verifySlhdsaSha2128s};

    struct PostQuantumSLHDSANaiveInsecure {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumSLHDSANaiveInsecure, msg: ByteString, sig: ByteString) {
