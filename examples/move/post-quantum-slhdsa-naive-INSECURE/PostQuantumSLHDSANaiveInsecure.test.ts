...
const source = readFileSync(join(__dirname, 'PostQuantumSLHDSANaiveInsecure.runar.move'), 'utf8');
const FILE_NAME = 'PostQuantumSLHDSANaiveInsecure.runar.move';
...
describe.skipIf(!runSlowTests)('PostQuantumSLHDSANaiveInsecure (Move)', () => {
