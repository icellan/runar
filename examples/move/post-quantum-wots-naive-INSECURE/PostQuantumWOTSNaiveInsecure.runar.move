...
module PostQuantumWOTSNaiveInsecure {
    use runar::types::{ByteString};
    use runar::crypto::{verifyWOTS};

    struct PostQuantumWOTSNaiveInsecure {
        pubkey: ByteString,
    }

    public fun spend(contract: &PostQuantumWOTSNaiveInsecure, msg: ByteString, sig: ByteString) {
