...
const source = readFileSync(join(__dirname, 'PrivateHelperOutputs.runar.move'), 'utf8');
const FILE_NAME = 'PrivateHelperOutputs.runar.move';

describe('PrivateHelperOutputs (Move)', () => {
