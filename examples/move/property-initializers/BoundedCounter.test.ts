...
const source = readFileSync(join(__dirname, 'BoundedCounter.runar.move'), 'utf8');
const FILE_NAME = 'BoundedCounter.runar.move';

describe('BoundedCounter (Move — Property Initializers)', () => {
