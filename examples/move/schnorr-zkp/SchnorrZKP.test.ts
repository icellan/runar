...
const source = readFileSync(join(__dirname, 'SchnorrZKP.runar.move'), 'utf8');
const FILE_NAME = 'SchnorrZKP.runar.move';
...
describe('SchnorrZKP (Move)', () => {
  ...
  // for the canonical commentary; this is the .runar.move mirror.
