...
const source = readFileSync(join(__dirname, 'HashRegistry.runar.move'), 'utf8');
const FILE_NAME = 'HashRegistry.runar.move';

const initialHash = '01020304050607080910111213141516171819ff';
const nextHash = 'a1a2a3a4a5a6a7a8a9aaabacadaeafb0b1b2b3b4';

describe('HashRegistry (Move)', () => {
  it('compiles via TestContract.fromSource with move parser', () => {
