...
class BabyBearExt4Demo(SmartContract):
    """Demonstrates Baby Bear Ext4 field arithmetic."""
    ...
    def check_mul(
        ...
        assert_(bb_ext4_mul0(a0, a1, a2, a3, b0, b1, b2, b3) == e0)
        assert_(bb_ext4_mul1(a0, a1, a2, a3, b0, b1, b2, b3) == e1)
        assert_(bb_ext4_mul2(a0, a1, a2, a3, b0, b1, b2, b3) == e2)
        assert_(bb_ext4_mul3(a0, a1, a2, a3, b0, b1, b2, b3) == e3)
    ...
    def check_inv(
        ...
        assert_(bb_ext4_inv0(a0, a1, a2, a3) == e0)
        assert_(bb_ext4_inv1(a0, a1, a2, a3) == e1)
        assert_(bb_ext4_inv2(a0, a1, a2, a3) == e2)
        assert_(bb_ext4_inv3(a0, a1, a2, a3) == e3)
