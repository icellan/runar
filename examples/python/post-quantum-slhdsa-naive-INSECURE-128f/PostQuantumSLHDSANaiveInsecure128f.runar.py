...
# THE FLAW
# --------
# `verify_slh_dsa_sha2_128f` (and any post-quantum signature primitive:
...
# THE CORRECT PATTERN
# -------------------
#   examples/python/post-quantum-wallet/   -- WOTS+ hybrid (ECDSA sig as msg)
#   examples/python/sphincs-wallet/        -- SLH-DSA hybrid (ECDSA sig as msg)
#
# Use those for any real PQ-secured wallet. This file is a teaching artifact.
# =============================================================================

from runar import SmartContract, ByteString, public, assert_, verify_slh_dsa_sha2_128f

class PostQuantumSLHDSANaiveInsecure128f(SmartContract):
    pubkey: ByteString
    ...
    def spend(self, msg: ByteString, sig: ByteString):
        assert_(verify_slh_dsa_sha2_128f(msg, sig, self.pubkey))
