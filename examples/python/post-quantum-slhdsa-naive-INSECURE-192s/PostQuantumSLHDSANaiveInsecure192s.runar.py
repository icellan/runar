...
# THE FLAW
# --------
# `verify_slh_dsa_sha2_192s` (and any post-quantum signature primitive:
...
from runar import SmartContract, ByteString, public, assert_, verify_slh_dsa_sha2_192s

class PostQuantumSLHDSANaiveInsecure192s(SmartContract):
    pubkey: ByteString
    ...
    def spend(self, msg: ByteString, sig: ByteString):
        assert_(verify_slh_dsa_sha2_192s(msg, sig, self.pubkey))
