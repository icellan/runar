...
# THE FLAW
# --------
# `verify_slh_dsa_sha2_256f` (and any post-quantum signature primitive:
...
from runar import SmartContract, ByteString, public, assert_, verify_slh_dsa_sha2_256f

class PostQuantumSLHDSANaiveInsecure256f(SmartContract):
    pubkey: ByteString
    ...
    def spend(self, msg: ByteString, sig: ByteString):
        assert_(verify_slh_dsa_sha2_256f(msg, sig, self.pubkey))
