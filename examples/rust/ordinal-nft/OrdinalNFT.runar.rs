...
///
/// A stateless P2PKH contract used to lock an ordinal NFT. The owner (holder
/// of the private key whose public key hashes to `pub_key_hash`) can unlock
/// and transfer the ordinal by providing a valid signature and public key.
///
