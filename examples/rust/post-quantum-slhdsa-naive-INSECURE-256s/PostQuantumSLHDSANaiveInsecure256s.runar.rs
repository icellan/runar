...
// THE CORRECT PATTERN
// -------------------
//   examples/rust/post-quantum-wallet/   -- WOTS+ hybrid (ECDSA sig as msg)
//   examples/rust/sphincs-wallet/        -- SLH-DSA hybrid (ECDSA sig as msg)
//
...
impl PostQuantumSLHDSANaiveInsecure256s {
    pub fn spend(&self, msg: &ByteString, sig: &ByteString) {
        assert!(verify_slh_dsa_sha2_256s(msg, sig, &self.pubkey));
    }
}
