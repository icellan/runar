...
fn example_p2pkh() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/p2pkh/P2PKH.tsop.ts"))?;
...
fn example_escrow() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/escrow/Escrow.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_counter() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/stateful-counter/Counter.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_fungible_token() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/token-ft/FungibleTokenExample.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_nft() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/token-nft/NFTExample.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_auction() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/auction/Auction.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_oracle_price_feed() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/oracle-price/OraclePriceFeed.tsop.ts"))?;
    print_summary(&artifact);
...
fn example_covenant_vault() -> Result<(), String> {
    ...
    let artifact = compile_from_source(Path::new("examples/covenant-vault/CovenantVault.tsop.ts"))?;
    print_summary(&artifact);
