...
import { parseInscriptionEnvelope } from '../../../packages/runar-sdk/src/ordinals/envelope.js';
import { BSV21 } from '../../../packages/runar-sdk/src/ordinals/bsv20.js';

const __dirname = dirname(fileURLToPath(import.meta.url));
const source = readFileSync(join(__dirname, 'BSV21Token.runar.sol'), 'utf8');
const FILE_NAME = 'BSV21Token.runar.sol';
