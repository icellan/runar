...
// THE CORRECT PATTERN
// -------------------
//   examples/sol/post-quantum-wallet/   -- WOTS+ hybrid (ECDSA sig as msg)
//   examples/sol/sphincs-wallet/        -- SLH-DSA hybrid (ECDSA sig as msg)
//
...
contract PostQuantumSLHDSANaiveInsecure128f is SmartContract {
    ...
    function spend(ByteString msg, ByteString sig) public {
        require(verifySLHDSA_SHA2_128f(msg, sig, this.pubkey));
    }
}
