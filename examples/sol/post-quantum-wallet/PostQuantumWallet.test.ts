...
const source = readFileSync(join(__dirname, 'PostQuantumWallet.runar.sol'), 'utf8');
const FILE_NAME = 'PostQuantumWallet.runar.sol';
...
describe('PostQuantumWallet (Solidity)', () => {
