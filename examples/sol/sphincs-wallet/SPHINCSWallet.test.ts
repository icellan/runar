...
const source = readFileSync(join(__dirname, 'SPHINCSWallet.runar.sol'), 'utf8');
const FILE_NAME = 'SPHINCSWallet.runar.sol';
...
describe.skipIf(!runSlowTests)('SPHINCSWallet (Solidity, Hybrid ECDSA + SLH-DSA-SHA2-128s)', () => {
