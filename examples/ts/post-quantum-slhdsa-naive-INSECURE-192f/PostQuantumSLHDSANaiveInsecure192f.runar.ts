...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_192f` (and any post-quantum signature primitive: WOTS+,
...
import { SmartContract, assert, verifySLHDSA_SHA2_192f } from 'runar-lang';
import type { ByteString } from 'runar-lang';

class PostQuantumSLHDSANaiveInsecure192f extends SmartContract {
  ...
  public spend(msg: ByteString, sig: ByteString) {
    assert(verifySLHDSA_SHA2_192f(msg, sig, this.pubkey));
  }
}
