...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_192s` (and any post-quantum signature primitive: WOTS+,
...
import { SmartContract, assert, verifySLHDSA_SHA2_192s } from 'runar-lang';
import type { ByteString } from 'runar-lang';

class PostQuantumSLHDSANaiveInsecure192s extends SmartContract {
  ...
  public spend(msg: ByteString, sig: ByteString) {
    assert(verifySLHDSA_SHA2_192s(msg, sig, this.pubkey));
  }
}
