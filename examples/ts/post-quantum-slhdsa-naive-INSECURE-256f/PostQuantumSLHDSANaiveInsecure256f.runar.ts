...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_256f` (and any post-quantum signature primitive: WOTS+,
...
// reuse the same `(msg, sig)` pair -- or pick any other `(msg, sig)` they
// have a signature for -- and the script still verifies. The coins can be
// stolen or replayed.
//
...
// THE CORRECT PATTERN
// -------------------
//   examples/ts/post-quantum-wallet/   -- WOTS+ hybrid (ECDSA sig as msg)
//   examples/ts/sphincs-wallet/        -- SLH-DSA hybrid (ECDSA sig as msg)
//
// Use those for any real PQ-secured wallet. This file is a teaching artifact.
// =============================================================================

import { SmartContract, assert, verifySLHDSA_SHA2_256f } from 'runar-lang';
import type { ByteString } from 'runar-lang';

class PostQuantumSLHDSANaiveInsecure256f extends SmartContract {
  ...
  public spend(msg: ByteString, sig: ByteString) {
    assert(verifySLHDSA_SHA2_256f(msg, sig, this.pubkey));
  }
}
