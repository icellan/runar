...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_256s` (and any post-quantum signature primitive: WOTS+,
...
import { SmartContract, assert, verifySLHDSA_SHA2_256s } from 'runar-lang';
import type { ByteString } from 'runar-lang';

class PostQuantumSLHDSANaiveInsecure256s extends SmartContract {
  ...
  public spend(msg: ByteString, sig: ByteString) {
    assert(verifySLHDSA_SHA2_256s(msg, sig, this.pubkey));
  }
}
