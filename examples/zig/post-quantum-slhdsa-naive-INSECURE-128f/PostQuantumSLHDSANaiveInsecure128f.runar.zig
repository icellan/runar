...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_128f` (and any post-quantum signature primitive:
...
pub const PostQuantumSLHDSANaiveInsecure128f = struct {
    pub const Contract = runar.SmartContract;

    pubkey: runar.ByteString,

    pub fn init(pubkey: runar.ByteString) PostQuantumSLHDSANaiveInsecure128f {
        return .{ .pubkey = pubkey };
    }

    pub fn spend(self: *const PostQuantumSLHDSANaiveInsecure128f, msg: runar.ByteString, sig: runar.ByteString) void {
        runar.assert(runar.verifySLHDSA_SHA2_128f(msg, sig, self.pubkey));
    }
};
