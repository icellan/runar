...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_192f` (and any post-quantum signature primitive:
...
pub const PostQuantumSLHDSANaiveInsecure192f = struct {
    pub const Contract = runar.SmartContract;

    pubkey: runar.ByteString,

    pub fn init(pubkey: runar.ByteString) PostQuantumSLHDSANaiveInsecure192f {
        return .{ .pubkey = pubkey };
    }

    pub fn spend(self: *const PostQuantumSLHDSANaiveInsecure192f, msg: runar.ByteString, sig: runar.ByteString) void {
        runar.assert(runar.verifySLHDSA_SHA2_192f(msg, sig, self.pubkey));
    }
};
