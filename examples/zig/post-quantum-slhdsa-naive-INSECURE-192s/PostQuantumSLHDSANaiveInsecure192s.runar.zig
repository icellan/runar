...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_192s` (and any post-quantum signature primitive:
...
// THE CORRECT PATTERN
// -------------------
//   examples/zig/post-quantum-wallet/   -- WOTS+ hybrid (ECDSA sig as msg)
//   examples/zig/sphincs-wallet/        -- SLH-DSA hybrid (ECDSA sig as msg)
//
...
pub const PostQuantumSLHDSANaiveInsecure192s = struct {
    pub const Contract = runar.SmartContract;

    pubkey: runar.ByteString,

    pub fn init(pubkey: runar.ByteString) PostQuantumSLHDSANaiveInsecure192s {
        return .{ .pubkey = pubkey };
    }

    pub fn spend(self: *const PostQuantumSLHDSANaiveInsecure192s, msg: runar.ByteString, sig: runar.ByteString) void {
        runar.assert(runar.verifySLHDSA_SHA2_192s(msg, sig, self.pubkey));
    }
};
