...
// THE FLAW
// --------
// `verifySLHDSA_SHA2_128s` (and any post-quantum signature primitive:
...
pub const PostQuantumSLHDSANaiveInsecure = struct {
    pub const Contract = runar.SmartContract;

    pubkey: runar.ByteString,

    pub fn init(pubkey: runar.ByteString) PostQuantumSLHDSANaiveInsecure {
        return .{ .pubkey = pubkey };
    }

    pub fn spend(self: *const PostQuantumSLHDSANaiveInsecure, msg: runar.ByteString, sig: runar.ByteString) void {
