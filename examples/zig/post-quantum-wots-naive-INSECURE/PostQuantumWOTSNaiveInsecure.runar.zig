...
pub const PostQuantumWOTSNaiveInsecure = struct {
    pub const Contract = runar.SmartContract;

    pubkey: runar.ByteString,

    pub fn init(pubkey: runar.ByteString) PostQuantumWOTSNaiveInsecure {
        return .{ .pubkey = pubkey };
    }

    pub fn spend(self: *const PostQuantumWOTSNaiveInsecure, msg: runar.ByteString, sig: runar.ByteString) void {
