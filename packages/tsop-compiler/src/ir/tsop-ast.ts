/**
 * TSOP AST types for the compiler.
 *
 * Re-exports from tsop-ir-schema. We define them inline so that the compiler
 * package can be built independently even if tsop-ir-schema has not been
 * compiled yet.
 */
