// ---------------------------------------------------------------------------
// tsop-lang/oracle/rabin.ts — Rabin signature oracle verification
// ---------------------------------------------------------------------------
...
// minimised way.
//
// The TSOP compiler inlines the Rabin verification as a sequence of
...
export function verifyRabinSig(
  ...
  throw new Error(
    'verifyRabinSig() cannot be called at runtime — compile this contract with the TSOP compiler.',
  );
}
