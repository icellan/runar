// ---------------------------------------------------------------------------
// tsop-sdk/state.ts — State management for stateful contracts
// ---------------------------------------------------------------------------
//
// Stateful TSOP contracts embed their state in the locking script as a
...
import type { StateField, TSOPArtifact } from 'tsop-ir-schema';
