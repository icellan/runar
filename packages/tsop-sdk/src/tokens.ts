// ---------------------------------------------------------------------------
// tsop-sdk/tokens.ts — Token UTXO management
// ---------------------------------------------------------------------------
...
import { TSOPContract } from './contract.js';
 ...
 *
 * This is a higher-level convenience wrapper around TSOPContract for the
...
export class TokenWallet {
  ...
  async getBalance(): Promise<bigint> {
    ...
    for (const utxo of utxos) {
      const contract = await TSOPContract.fromTxId(
        this.artifact,
        utxo.txid,
        utxo.outputIndex,
        this.provider,
